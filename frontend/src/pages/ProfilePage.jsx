...
import { Camera, Mail, User, Phone, Check, Edit2, Loader2, ArrowLeft } from "lucide-react";
  ...
  return (
    <div className="min-h-[100dvh] pt-20">
      <div className="max-w-2xl mx-auto p-4 py-8">
        <div className="bg-base-300 rounded-xl p-6 space-y-8 shadow-lg relative">
          <button 
            onClick={() => navigate(-1)}
            className="absolute top-4 left-4 btn btn-ghost btn-circle btn-sm flex items-center justify-center hover:bg-base-200"
            title="Quay lại"
          >
