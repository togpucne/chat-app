...
const PREVIEW_MESSAGES = [
  ...
  { id: 2, content: "Mình khỏe, cảm ơn bạn!", isSent: true },
  { id: 3, content: "Hôm nay bạn có rảnh không?", isSent: false },
  { id: 4, content: "Tối nay có, bạn muốn đi đâu?", isSent: true },
  { id: 5, content: "Đi xem MU đá bóng nhé!", isSent: false },
];
            ...
            <div className="bg-base-100 rounded-xl shadow-sm overflow-hidden">
              ...
              <div className="px-4 py-3 border-b border-base-300 bg-base-100">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-medium text-sm">Judoit Nguyen</h3>
